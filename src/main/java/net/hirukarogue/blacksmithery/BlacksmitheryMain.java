...
@Mod(BlacksmitheryMain.MOD_ID)
public class BlacksmitheryMain {

    public static final String MOD_ID = "blacksmithery";

    public static final Logger LOGGER = LogUtils.getLogger();

    public BlacksmitheryMain(IEventBus modEventBus, ModContainer modContainer) {
